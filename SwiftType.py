...
def start_program():
    ...
    text_entry = tk.Text(root, font=("Arial", 12), height=15, wrap="word", bd=2)
    ...
    delay_label = tk.Label(root, text="Startup Delay:",
                           font=("Arial", 12), bg="#f7f7f7")
    ...
    start_button = tk.Button(button_frame, text="Start",
                             font=("Arial", 12), command=Typer().start, bg="#4caf50", fg="white", bd=0, padx=20, pady=10)
    start_button.pack(side="left", padx=10)

    exit_button = tk.Button(button_frame, text="Exit",
                            font=("Arial", 12), command=root.destroy, bg="#f44336", fg="white", bd=0, padx=20, pady=10)
